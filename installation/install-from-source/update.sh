...
export PYTHON="$(pwd)/miniconda3/envs/hummingbot-professional/bin/python3"
export hummingbotPath="$(pwd)/hummingbot-professional" && cd $hummingbotPath
# REMOVE OLD INSTALLATION
${CONDAPATH}/bin/deactivate
./uninstall
rm -rf $(pwd)/miniconda3/envs/hummingbot-professional
./clean
# UPDATE HUMMINGBOT
