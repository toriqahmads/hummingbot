...
BITTREX_DATETIME_FORMAT = '%Y-%m-%dT%H:%M:%S.%fZ'

# WEBSOCKET CHANNEl KEYS
TRADE_EVENT_KEY = "trade"
DIFF_EVENT_KEY = "orderbook_500"
...
ORDER_TRADES_URL = "/orders/{}/executions"
...
ORDER_TRADES_LIMIT_ID = "trades"

RATE_LIMITS = [
    RateLimit(limit_id=ORDERBOOK_SNAPSHOT_LIMIT_ID, limit=60, time_interval=60),
    RateLimit(limit_id=SERVER_TIME_URL, limit=60, time_interval=1),
    ...
    RateLimit(limit_id=ORDER_TRADES_LIMIT_ID, limit=60, time_interval=60),
