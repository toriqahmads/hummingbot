...
class TokocryptoUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = TokocryptoAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        self.time_synchronizer = TimeSynchronizer()
        self.time_synchronizer.add_time_offset_ms_sample(0)

        client_config_map = ClientConfigAdapter(ClientConfigMap())
        self.connector = TokocryptoExchange(
        ...
        self.data_source = TokocryptoAPIUserStreamDataSource(
            auth=self.auth,
    ...
    @patch("hummingbot.connector.exchange.tokocrypto.tokocrypto_api_user_stream_data_source.TokocryptoAPIUserStreamDataSource"
           "._ping_listen_key",
