...
class TokocryptoExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def latest_prices_url(self):
        ...
        url = f"{url}?symbol={self.tokocrypto_exchange_symbol_associated_to_pair(self.base_asset, self.quote_asset)}"
        return url
    ...
    def order_creation_url(self):
        url = web_utils.private_rest_url(CONSTANTS.ORDER_BUY_URL, domain=self.exchange._domain)
        return url
    ...
    def tokocrypto_exchange_symbol_associated_to_pair(self, base_token: str, quote_token: str) -> str:
    ...
    def create_exchange_instance(self):
        ...
        return TokocryptoExchange(
            ...
            tokocrypto_api_key="testAPIKey",
            tokocrypto_api_secret="testSecret",
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(CONSTANTS.SIDE_BUY if order.trade_type is TradeType.BUY else CONSTANTS.SIDE_SELL, str(request_data["side"]))
        self.assertEqual(int(TokocryptoExchange.tokocrypto_order_type(OrderType.LIMIT)), int(request_data["type"]))
    ...
    def validate_order_status_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(self.tokocrypto_exchange_symbol_associated_to_pair(self.base_asset, self.quote_asset),
    ...
    def test_update_order_fills_from_trades_triggers_filled_event(self, mock_api):
        ...
        trade_fill = {
            "symbol": self.tokocrypto_exchange_symbol_associated_to_pair(self.base_asset, self.quote_asset),
            "tradeId": 28457,
        ...
        mock_response = {
            ...
            "msg": "success",
            "data": {
                "list": [trade_fill, trade_fill_non_tracked_order]
            },
        ...
        self.assertEqual(self.tokocrypto_exchange_symbol_associated_to_pair(self.base_asset, self.quote_asset), request_params["symbol"])
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        self.exchange._last_poll_timestamp = (self.exchange.current_timestamp -
                                              self.exchange.UPDATE_ORDER_STATUS_MIN_INTERVAL - 1)
        self.exchange._last_trades_poll_tokocrypto_timestamp = 10
        self.async_run_with_timeout(self.exchange._update_order_fills_from_trades())
    ...
    def test_update_order_fills_from_trades_with_repeated_fill_triggers_only_one_event(self, mock_api):
        ...
        mock_response = {
            ...
            "msg": "success",
            "data": {
                "list": [trade_fill_non_tracked_order, trade_fill_non_tracked_order]
            },
            "timestamp": 1499865549590
        }
        mock_api.get(regex_url, body=json.dumps(mock_response))
    ...
    def test_update_order_status_when_failed(self, mock_api):
        ...
        order_status = {
            ...
            "data": {
                ...
                "status": 5,
                "origQty": "1.0",
                "origQuoteQty": str(Decimal("0")),
                "executedPrice": str(Decimal("0")),
                "executedQuoteQty": str(Decimal("0")),
                "executedQty": "0.0",
                "createTime": 1499827319559,
            },
    ...
    def _order_cancelation_request_successful_mock_response(self, order: InFlightOrder) -> Any:
        return {
            ...
            "message": "success",
            "data": {
                "orderId": order.exchange_order_id or "dummyOrdId",
                "bOrderId": "100001",
                "bOrderListId": -1,
                "clientId": order.client_order_id,
                "symbol": self.tokocrypto_exchange_symbol_associated_to_pair(self.base_asset, self.quote_asset),
    ...
    def _order_fills_request_partial_fill_mock_response(self, order: InFlightOrder):
        return {
            ...
            "data": {
                "list": [
                    {
                        "symbol": self.tokocrypto_exchange_symbol_associated_to_pair(order.base_asset, order.quote_asset),
