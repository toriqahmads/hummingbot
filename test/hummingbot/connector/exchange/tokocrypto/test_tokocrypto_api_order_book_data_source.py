...
class TokocryptoAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = TokocryptoExchange(
            ...
            domain=self.domain)
        self.data_source = TokocryptoAPIOrderBookDataSource(trading_pairs=[self.trading_pair], connector=self.connector, api_factory=self.connector._web_assistants_factory, domain=self.domain)
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.tokocrypto.tokocrypto_api_order_book_data_source"
           ".TokocryptoAPIOrderBookDataSource._sleep")
